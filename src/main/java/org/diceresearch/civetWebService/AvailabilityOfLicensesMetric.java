 ...
 * 
 * This metric first checks if the provided dataset has any rights or license
 * information available in the form of predicates dct:rights or dct:license
 * respectively.
 * 
 * If license/rights information not available at dataset then check all the
 * available distributions in a dataset for license information and based on
 * that a star rating is provided.
 * 
	...
	public Integer compute(Model model, String datasetUri) throws Exception {
		...
		if (NumberOfLicensesInDataset == 0) {
...

			{
				 ...
				 * distributions or there maybe both dct:license and dct:rights keyword. Check
				 * for rights here.
				 */
